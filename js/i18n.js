/* =============================================
   AUREA DESCANSO — Multidioma (i18n)
...
(function () {
  ...
  var DICT = {
    es: {
      ...
      'footer.claim': 'Descanso diseñado y fabricado en España. 100 noches de prueba y 10 años de garantía.',
      'footer.shop': 'Comprar',
      'footer.help': 'Ayuda',
    ...
    en: {
      ...
      'footer.claim': 'Rest designed and made in Spain. 100-night trial and a 10-year warranty.',
      'footer.shop': 'Shop',
      'footer.help': 'Help',
    ...
    it: {
      ...
      'footer.claim': 'Riposo progettato e prodotto in Spagna. 100 notti di prova e 10 anni di garanzia.',
    ...
    fr: {
      ...
      'footer.contact': 'Contact',
      'footer.claim': 'Un sommeil conçu et fabriqué en Espagne. 100 nuits d’essai et 10 ans de garantie.',
      'footer.shop': 'Acheter',
      'footer.help': 'Aide',
    ...
    de: {
      ...
      'footer.claim': 'Schlafkomfort, entworfen und gefertigt in Spanien. 100 Nächte Probeschlafen und 10 Jahre Garantie.',
  ...
  var HOME = {
    es: {
      'home.products': 'Nuestros colchones',
      'home.serenity_desc': 'Firmeza media. Doble cara invierno-verano con núcleo HR de 28 kg/m³ y viscoelástica adaptable.',
      'home.celestial_desc': 'Firmeza media-alta. Muelles ensacados con doble capa de viscoelástica.',
      ...
      'fab.lead': 'Cada colchón Aurea sale de nuestra propia línea de producción: el mismo núcleo, el mismo acolchado tapa a tapa y la misma marca que recibes en casa. Sin marcas blancas, sin distribuidores que inflen el precio.',
      ...
      'seals.eyebrow': 'La promesa Aurea',
      ...
      'seals.s4t': '10 años de garantía', 'seals.s4d': 'Atención directa de fábrica',
    ...
    en: {
      'home.products': 'Our mattresses',
      'home.serenity_desc': 'Medium firmness. Dual winter–summer sides with a 28 kg/m³ HR core and adaptive memory foam.',
      'home.celestial_desc': 'Medium-firm. Pocket springs with a double layer of memory foam.',
      ...
      'fab.lead': 'Every Aurea mattress comes off our own production line: the same core, the same tufted padding and the same brand you receive at home. No white labels, no distributors inflating the price.',
      ...
      'seals.eyebrow': 'The Aurea promise',
      ...
      'seals.s4t': '10-year warranty', 'seals.s4d': 'Direct support from the factory',
    ...
    it: {
      'home.products': 'I nostri materassi',
      'home.serenity_desc': 'Rigidità media. Doppia faccia inverno–estate con nucleo HR da 28 kg/m³ e memory adattabile.',
      'home.celestial_desc': 'Rigidità medio-alta. Molle insacchettate con doppio strato di memory.',
      ...
      'fab.lead': 'Ogni materasso Aurea esce dalla nostra linea di produzione: lo stesso nucleo, la stessa imbottitura e lo stesso marchio che ricevi a casa. Niente marchi terzi, niente distributori che gonfiano il prezzo.',
      ...
      'seals.eyebrow': 'La promessa Aurea',
      ...
      'seals.s4t': '10 anni di garanzia', 'seals.s4d': 'Assistenza diretta dalla fabbrica',
    ...
    fr: {
      'home.products': 'Nos matelas',
      'home.serenity_desc': 'Fermeté moyenne. Double face hiver–été avec noyau HR de 28 kg/m³ et mousse à mémoire adaptable.',
      'home.celestial_desc': 'Fermeté moyenne-ferme. Ressorts ensachés avec double couche de mousse à mémoire.',
      ...
      'fab.lead': 'Chaque matelas Aurea sort de notre propre ligne de production : le même noyau, le même capitonnage et la même marque que vous recevez chez vous. Sans marques blanches, sans distributeurs qui gonflent le prix.',
      ...
      'seals.eyebrow': 'La promesse Aurea',
      ...
      'seals.s4t': '10 ans de garantie', 'seals.s4d': 'Assistance directe de l’usine',
    ...
    de: {
      'home.products': 'Unsere Matratzen',
      'home.serenity_desc': 'Mittlere Festigkeit. Winter-/Sommer-Doppelseite mit 28 kg/m³ HR-Kern und anpassungsfähigem Memory-Schaum.',
      'home.celestial_desc': 'Mittel-fest. Taschenfederkern mit doppelter Memory-Schaum-Schicht.',
      ...
      'fab.lead': 'Jede Aurea-Matratze kommt aus unserer eigenen Produktion: derselbe Kern, dieselbe Polsterung und dieselbe Marke, die du zu Hause erhältst. Keine Handelsmarken, keine Zwischenhändler, die den Preis aufblähen.',
      ...
      'seals.eyebrow': 'Das Aurea-Versprechen',
      ...
      'seals.s4t': '10 Jahre Garantie', 'seals.s4d': 'Direkter Support ab Werk',
  ...
  var EXTRA = {
    es: {
      'ann.1': '−10 % en tu primera compra con el código AUREA10',
      ...
      'chk.coupon_ok': 'Código AUREA10 aplicado: −10 %',
      ...
      'soon.teaser': 'El próximo capítulo del descanso Aurea. Estamos afinando cada detalle. Muy pronto.',
      'soon.lead': 'Algo grande está en camino. El Aurea Celestial llegará para subir el listón del descanso — y serás de los primeros en saberlo.',
    ...
    en: {
      'ann.1': '−10% off your first order with code AUREA10',
      ...
      'chk.coupon_ok': 'Code AUREA10 applied: −10%',
      ...
      'soon.teaser': 'The next chapter of Aurea rest. We are perfecting every detail. Very soon.',
      'soon.lead': 'Something big is on its way. The Aurea Celestial is coming to raise the bar — and you will be among the first to know.',
    ...
    it: {
      'ann.1': '−10% sul tuo primo ordine con il codice AUREA10',
      ...
      'chk.coupon_ok': 'Codice AUREA10 applicato: −10%',
      'chk.coupon_bad': 'Codice non valido',
      'chk.discount': 'Sconto',
      'soon.badge': 'Prossimamente',
      'soon.price': 'Prezzo da svelare',
      'soon.notify': 'Avvisami al lancio',
      'soon.teaser': 'Il prossimo capitolo del riposo Aurea. Stiamo rifinendo ogni dettaglio. Molto presto.',
      'soon.lead': 'Sta arrivando qualcosa di grande. L’Aurea Celestial alzerà l’asticella del riposo — e sarai tra i primi a saperlo.',
    ...
    fr: {
      'ann.1': '−10 % sur votre première commande avec le code AUREA10',
      ...
      'chk.coupon_ok': 'Code AUREA10 appliqué : −10 %',
      'chk.coupon_bad': 'Code non valide',
      'chk.discount': 'Remise',
      'soon.badge': 'Bientôt',
      'soon.price': 'Prix à dévoiler',
      'soon.notify': 'Prévenez-moi au lancement',
      'soon.teaser': 'Le prochain chapitre du repos Aurea. Nous peaufinons chaque détail. Très bientôt.',
      'soon.lead': 'Quelque chose de grand arrive. L’Aurea Celestial va élever le niveau du repos — et vous serez parmi les premiers informés.',
    ...
    de: {
      'ann.1': '−10 % auf deine erste Bestellung mit dem Code AUREA10',
      ...
      'chk.coupon_ok': 'Code AUREA10 angewendet: −10 %',
      ...
      'soon.teaser': 'Das nächste Kapitel des Aurea-Schlafs. Wir verfeinern jedes Detail. Sehr bald.',
      'soon.lead': 'Etwas Großes ist unterwegs. Die Aurea Celestial hebt den Schlaf auf ein neues Level — und du erfährst es als Erster.',
  ...
  function apply(l) {
    ...
    window.dispatchEvent(new CustomEvent('aurea:lang', { detail: l }));
  }
  function setLang(l) {
  ...
  window.AureaI18n = { t: t, lang: getLang, set: setLang };
