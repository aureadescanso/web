...
(function () {
  ...
  var EXTRA = {
    es: {
      ...
      'ck.text': 'Usamos cookies de <strong>TikTok</strong> y <strong>Meta</strong> para medir la publicidad, y <strong>Google Analytics</strong> para saber qué páginas te interesan. Sin ellas la web va igual de bien. Puedes cambiar de opinión cuando quieras en la <a href="/cookies">política de cookies</a>.',
      'ck.yes': 'Aceptar',
      'ck.no': 'Rechazar',
      'ck.aria': 'Aviso de cookies',
      'ck.dot': 'Preferencias de cookies',
      'ck.dotOn': 'Cookies aceptadas · pulsa para cambiarlo',
      'ck.dotOff': 'Cookies rechazadas · pulsa para cambiarlo',
    ...
    en: {
      ...
      'ck.text': 'We use <strong>TikTok</strong> and <strong>Meta</strong> cookies to measure our advertising, and <strong>Google Analytics</strong> to see which pages people find useful. The site works just as well without them. You can change your mind any time in our <a href="/cookies">cookie policy</a>.',
      'ck.yes': 'Accept',
      'ck.no': 'Reject',
      'ck.aria': 'Cookie notice',
      'ck.dot': 'Cookie preferences',
      'ck.dotOn': 'Cookies accepted · tap to change',
      'ck.dotOff': 'Cookies rejected · tap to change',
    ...
    it: {
      ...
      'ck.text': 'Usiamo cookie di <strong>TikTok</strong> e <strong>Meta</strong> per misurare la pubblicità, e <strong>Google Analytics</strong> per capire quali pagine interessano. Senza di essi il sito funziona ugualmente. Puoi cambiare idea quando vuoi nella <a href="/cookies">politica dei cookie</a>.',
      'ck.yes': 'Accetta',
      'ck.no': 'Rifiuta',
      'ck.aria': 'Avviso sui cookie',
      'ck.dot': 'Preferenze sui cookie',
      'ck.dotOn': 'Cookie accettati · tocca per cambiare',
      'ck.dotOff': 'Cookie rifiutati · tocca per cambiare',
    ...
    fr: {
      ...
      'ck.text': 'Nous utilisons des cookies <strong>TikTok</strong> et <strong>Meta</strong> pour mesurer notre publicité, et <strong>Google Analytics</strong> pour savoir quelles pages intéressent. Le site marche aussi bien sans eux. Vous pouvez changer d’avis à tout moment dans la <a href="/cookies">politique de cookies</a>.',
      'ck.yes': 'Accepter',
      'ck.no': 'Refuser',
      'ck.aria': 'Avis sur les cookies',
      'ck.dot': 'Préférences de cookies',
      'ck.dotOn': 'Cookies acceptés · appuyez pour changer',
      'ck.dotOff': 'Cookies refusés · appuyez pour changer',
    ...
    de: {
      ...
      'ck.text': 'Wir verwenden Cookies von <strong>TikTok</strong> und <strong>Meta</strong>, um unsere Werbung zu messen, und <strong>Google Analytics</strong>, um zu sehen, welche Seiten interessieren. Ohne sie funktioniert die Website genauso gut. Du kannst es jederzeit in der <a href="/cookies">Cookie-Richtlinie</a> ändern.',
      'ck.yes': 'Annehmen',
      'ck.no': 'Ablehnen',
      'ck.aria': 'Cookie-Hinweis',
      'ck.dot': 'Cookie-Einstellungen',
      'ck.dotOn': 'Cookies akzeptiert · zum Ändern tippen',
      'ck.dotOff': 'Cookies abgelehnt · zum Ändern tippen',
